...
//Globals
struct currentValidID; //stores current valid user ID Parameters
CANDIDATE candidateArray[20]; //to share information to the candidates
...
//Will check whether the global branch code and inputed branch code is matching or not1
...
printf("Created Successfully\n");
       ...
       FILE *fp;
       char filename[20];
       for(int i=1;1<=numberOfCandidates; i++){
       ...
       int getWinner(){
            ...
            for(int i = 0;i < numberOfCandidates; i++){
                if(candidateArray[i].votes > maxV) {
                    winnerCid = candidatesArray[i].votes;
                }
       ...
       void inititalNewElection()
       {
        ...
        for (int i = 0;i < numberOfCandidates; i++)
        {
            ...
            ptintf("Enter name of candidates %d: ",i+1);
            ...
            while(1){
                ...
                while(1)
                {
                    ...
                    case '2':
                        ...
                        break;
                    case '3':
                        printf("\nEnter uder ID to delete its vote: ");
                        scanf("%s",inputID);
